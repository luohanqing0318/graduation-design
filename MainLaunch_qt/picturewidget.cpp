    ...
    ui(new Ui::Picturewidget)
{
    // 添加ImageOpacity属性;
        ...
        this->setFixedSize(QSize(800, 250));
...
void Picturewidget::setImageList(QStringList imageFileNameList)
{
    m_imageFileNameList = imageFileNameList;
}

void Picturewidget::addImage(QString imageFileName)
{
    m_imageFileNameList.append(imageFileName);
}

void Picturewidget::startPlay()
{
...
void Picturewidget::paintEvent(QPaintEvent *event)
{
    QPainter painter(this);
      ...
      {
          QPixmap backPixmap = QPixmap(":/1.png");
...
void Picturewidget::onImageChangeTimeout()
{
    // 设置前后的图片;
        m_currentPixmap = QPixmap(m_imageFileNameList.at(m_currentDrawImageIndx));
